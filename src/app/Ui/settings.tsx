      ...
      <div className="mb-4">
        ...
        <div className="border-t-2 border-b-2 border-customGray p-3 rounded-md flex flex-col md:flex-row justify-between items-center text-sm">
          <div className="flex-1">
            ...
            <p>We recommend requiring a verification</p>
              <p> code in addition to your password.</p>
          </div>
          <div className="flex items-center space-x-2 mr-80 ">
      ...
      <div className=''>
        ...
        <div className="border-t-2 border-CustomGray2 p-2 mb-2 flex flex-col md:flex-row justify-between items-center text-sm">
          ...
          <div className="flex-1 md:flex-none">
            <p className="text-gray-400 mr-16"><Image src={Vietnamflag} alt="flag" className="rounded-full w-4 h-4 mr-2 inline-block" />Ninh Binh, Vietnam&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Current session</p>
          </div>
        ...
        <div className="border-t-2 border-CustomGray2 p-2 mb-2 flex flex-col md:flex-row justify-between items-center text-sm">
          ...
          <div className="flex-1 md:flex-none">
            <p className="text-gray-400 mr-20"><Image src={Mexicoflag}  alt="flag" className="rounded-full w-4 h-4 mr-2 inline-block" />Mexico city, Mexico&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1 month ago</p>
          </div>
          <FiTrash2 className='text-lg text-gray-600'/>
        </div>
           <div className="border-t-2 border-b-2  border-CustomGray2 p-2 mb-2 flex flex-col md:flex-row justify-between items-center text-sm">
          <div className="flex-1 flex items-center">
            <div className="p-2 bg-CustomGray2 rounded-md mr-2">
              <Image src={Appleicon} alt='' className="w-4 h-4" />
            </div>
